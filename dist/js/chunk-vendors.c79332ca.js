 ...
 * limitations under the License.
 */
async function qe(e,t){return M(e,"POST","/v1/accounts:signInWithEmailLink",A(e,t))}async function Je(e,t){return M(e,"POST","/v1/accounts:signInWithEmailLink",A(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gn=new O(3e4,6e4);function qn(){const e=Gt().___jsl;if(null===e||void 0===e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let n=0;n<e.CP.length;n++)e.CP[n]=null}function Jn(e){return new Promise(((t,n)=>{var r,o,i;function s(){qn(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{qn(),n(m(e,"network-request-failed"))},timeout:Gn.get()})}if(null===(o=null===(r=Gt().gapi)||void 0===r?void 0:r.iframes)||void 0===o?void 0:o.Iframe)t(gapi.iframes.getContext());else{if(!(null===(i=Gt().gapi)||void 0===i?void 0:i.load)){const t=Ce("iframefcb");return Gt()[t]=()=>{gapi.load?s():n(m(e,"network-request-failed"))},Se(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}s()}})).catch((e=>{throw Yn=null,e}))}let Yn=null;function Xn(e){return Yn=Yn||Jn(e),Yn}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
